 ...
 */
$config['site_title']                 = "Srivijaya.id";       // Site Title, example.com
$config['admin_email']                = "halo@srivijaya.id"; // Admin Email, admin@example.com
$config['default_group']              = 'reader';           // Default group, use name
